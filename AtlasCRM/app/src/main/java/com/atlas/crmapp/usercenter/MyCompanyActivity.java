...
public class MyCompanyActivity extends BaseStatusActivity implements MyCompanyDialogListener{
    ...
    protected void prepareActivityData() {
        ...
        BizDataRequest.requestGetVisibleCompanys(MyCompanyActivity.this, false, statusLayout, new BizDataRequest.OnVisibleCompanysRequestResult() {
            @Override
    ...
    private void showShopChoiceDialog() {
        ...
        easy =new EasyDialog(this)
                .setLayout(view)
                .setBackgroundColor(MyCompanyActivity.this.getResources().getColor(R.color.white_color))
                ...
                .setOutsideColor(MyCompanyActivity.this.getResources().getColor(R.color.dialog_outside_bg))
                .show();
        ...
        v1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                CorporationCouponActivity.newInstance(MyCompanyActivity.this, company.name);
                easy.dismiss();
            }
        });
        ...
        v2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                CorporationBillActivity.startActivity(MyCompanyActivity.this, company.name);
                easy.dismiss();
            }
        });
        ...
        v3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MyCompanyActivity.this, CorporationMemberActivity.class);
        ...
        v4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MyCompanyActivity.this, CorporationInfoEditActivity.class);
