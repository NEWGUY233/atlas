 ...
 */
public class MSpringView extends ViewGroup{
...
//    private boolean _i1sOverlap;             //保存用户动态设置样式时传入的参数
    ...
    public MSpringView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public int getHeadHeight(){
        return this.HEADER_LIMIT_HEIGHT;
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent event) {
        ...
        if (onPullListener != null)
            onPullListener.onPull(-getScrollY());
        switch (action){
...
//                        return false;
    ...
    private void restSmartPosition(){
        if (onPullListener != null)
            onPullListener.onUp(-getScrollY());
...
//        return false;
    ...
    private boolean isTopOverFarm(){
        if (type==Type.OVERLAP){
            ...
            return -getScrollY()> HEADER_LIMIT_HEIGHT/2;
        }else
            return false;
    }
...
//                    ((ListView) contentView).smoothScrollBy(-1,0);
    ...
    private SpringView.DragHander _headerHander;
    private SpringView.DragHander _footerHander;
    private SpringView.DragHander headerHander;
    private SpringView.DragHander footerHander;
    public SpringView.DragHander getHeader(){
        return headerHander;
    }
    public SpringView.DragHander getFooter(){
        return footerHander;
    }
    public void setHeader(SpringView.DragHander headerHander) {
    ...
    private void setHeaderIn(SpringView.DragHander headerHander){
    ...
    public void setFooter(SpringView.DragHander footerHander) {
    ...
    private void setFooterIn(SpringView.DragHander footerHander) {
