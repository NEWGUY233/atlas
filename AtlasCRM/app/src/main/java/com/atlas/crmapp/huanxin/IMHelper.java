...
import com.atlas.crmapp.huanxin.db.IMDBManager;
import com.atlas.crmapp.huanxin.db.InviteMessgeDao;
import com.atlas.crmapp.huanxin.db.UserDao;
import com.atlas.crmapp.huanxin.domain.EmojiconExampleGroupData;
import com.atlas.crmapp.huanxin.domain.InviteMessage;
import com.atlas.crmapp.huanxin.domain.RobotUser;
import com.atlas.crmapp.huanxin.parse.PreferenceManager;
import com.atlas.crmapp.huanxin.parse.UserProfileManager;
...
//import com.atlas.crmapp.huanxin.receiver.CallReceiver;
        ...
        easeUI.getNotifier().setNotificationInfoProvider(new EaseNotificationInfoProvider() {
            ...
            public String getDisplayedText(EMMessage message) {
                ...
                if(message.getType() == Type.TXT){
                    ticker = ticker.replaceAll("\\[.{2,3}\\]", appContext.getString(R.string.t22));
                }
...
//        appContext.registerReceiver(callReceiver, callFilter);
    ...
    protected void onUserException(String exception){
        ...
        String exceptionStr = "";
        if(exception == Constant.ACCOUNT_REMOVED){
            exceptionStr = appContext.getString(R.string.t23);
        }else if(exception == Constant.ACCOUNT_CONFLICT){
            exceptionStr = appContext.getString(R.string.t24);
        }
        if(StringUtils.isNotEmpty(exceptionStr)){
            showToast(exceptionStr);
        }
    	...
    	messageListener = new EMMessageListener() {
			...
			public void onMessageReceived(List<EMMessage> messages) {
			    for (EMMessage message : messages) {
                    ...
                    if(!TextUtils.isEmpty(userName)&&!hxIdFrom.equals(userName)) {
   ...
   /* public Map<String, EaseUser> getContactList() {
	...
	public Map<String, RobotUser> getRobotList() {
		if (isLoggedIn() && robotList == null) {
			robotList = IMModel.getRobotList();
		}
		return robotList;
	}
