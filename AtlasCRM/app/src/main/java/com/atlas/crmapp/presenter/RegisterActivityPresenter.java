...
public class RegisterActivityPresenter extends BasePresenter {
    ...
    public RegisterActivityPresenter(RegisterActivity fragment){
        this.activity = fragment;
        context = fragment;
    }

    public void postCode(String mPhoneNo, final String zipCode){
    ...
    public void postCode(String mPhoneNo, final String zipCode,String type){
        if(StringUtils.isEmpty(mPhoneNo) ){
            showToast(context, context.getString(R.string.input_phone_error));
            return;
        }
