...
public class PrintSMFragment extends BaseFragment {
...
//        recyclerView.setAdapter(new MyPrintAdapter(getContext(),MyPrintAdapter.SM));


        adapter = new MyPrintAdapter(getContext(),MyPrintAdapter.SM);
    ...
    private void getData(){
        BizDataRequest.getPrint(getContext(), page, MyPrintActivity.SCAN, statusLayout, new BizDataRequest.MyPrintRequestRescult() {
            @Override
