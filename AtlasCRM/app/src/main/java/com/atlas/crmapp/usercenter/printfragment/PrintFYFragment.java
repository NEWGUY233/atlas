...
public class PrintFYFragment extends BaseFragment {
...
//        recyclerView.setAdapter(new MyPrintAdapter(getContext(),MyPrintAdapter.FY));

        adapter = new MyPrintAdapter(getContext(),MyPrintAdapter.FY);
    ...
    private void getData(){
        BizDataRequest.getPrint(getContext(), page, MyPrintActivity.COPY, statusLayout, new BizDataRequest.MyPrintRequestRescult() {
            @Override
