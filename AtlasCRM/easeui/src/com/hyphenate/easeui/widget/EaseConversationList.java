...
public class EaseConversationList extends ListView {
    ...
    private ICanAddTopView iCanAddTopView ;
    ...
    //添加联系人头部
    public void setICanAddTopView(ICanAddTopView iCanAddTopView){
        this.iCanAddTopView = iCanAddTopView;
    }
    ...
    public void init(List<EMConversation> conversationList, EaseConversationListHelper helper){
        ...
        if(iCanAddTopView != null){//必须在setAdapter之前执行addHeaderView方法，否则会出现以下异常
            iCanAddTopView.addTopView();
        }
        setAdapter(adapter);
    ...
    public interface ICanAddTopView{
        void addTopView();
    }
}
