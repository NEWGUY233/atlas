...
import com.hyphenate.easeui.utils.UiUtil;
...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    protected void setUpView() {
        ...
        if (chatType == EaseConstant.CHATTYPE_SINGLE) {
            ...
            titleBar.setRightImageResource(R.drawable.ic_more);
        } else {
    ...
    private EasyDialog easy;
    private void showDialog() {
        int[] attachedViewLocation = new int[2];
        titleBar.getRightLayout().getLocationOnScreen(attachedViewLocation);
        attachedViewLocation[0] +=  titleBar.getRightLayout().getWidth() / 4 + UiUtil.dipToPx(getActivity(), 5);
        attachedViewLocation[1] +=  titleBar.getRightLayout().getHeight();
        View view = getActivity().getLayoutInflater().inflate(R.layout.layout_dialog_im_chat, null);
        easy =new EasyDialog(getActivity())
                .setLayout(view)
                .setBackgroundColor(getActivity().getResources().getColor(R.color.background_color_black))
                .setGravity(EasyDialog.GRAVITY_BOTTOM)
                .setLocationByAttachedView(titleBar.getRightLayout())
                .setTouchOutsideDismiss(true)
                .setLocation(attachedViewLocation)
                .setMatchParent(false)
                .setOutsideColor(getActivity().getResources().getColor(R.color.dialog_outside_bg))
                .show();
    ...
    class MyItemClickListener implements EaseChatExtendMenu.EaseChatExtendMenuItemClickListener{
        ...
        public void onClick(int itemId, View view) {
            ...
            case ITEM_LOCATION:
                ...
                startActivityForResult(new Intent(getActivity(), GNavMapActivity.class).putExtra("show", false), REQUEST_CODE_MAP);
                break;
